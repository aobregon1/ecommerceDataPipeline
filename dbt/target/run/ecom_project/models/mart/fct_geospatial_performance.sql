...
create or replace transient table ECOMMERCE_DATA_PIPELINE.mart.fct_geospatial_performance
    
    
    
    as (with customer_stats as (
...
select
    ...
    g.geolocation_city, -- Your cleaned city names!
    g.geolocation_state,
...
from ECOMMERCE_DATA_PIPELINE.stage.geolocation g
