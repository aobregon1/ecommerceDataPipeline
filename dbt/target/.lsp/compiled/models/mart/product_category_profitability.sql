with items as (
    select * from ECOMMERCE_DATA_PIPELINE.RAW_stage.order_items
),

products as (
    select * from ECOMMERCE_DATA_PIPELINE.RAW_stage.products
),
...
reviews as (
    ...
    from ECOMMERCE_DATA_PIPELINE.RAW_stage.order_reviews
    group by 1
)
